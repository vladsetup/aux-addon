...
function SlashCmdList.AUX(command)
    ...
    elseif arguments[1] == 'post' and arguments[2] == 'duration' and  T.map('6', post.DURATION_6, '24', post.DURATION_24, '72', post.DURATION_72)[arguments[3]] then
        aux.account_data.post_duration = T.map('6', post.DURATION_6, '24', post.DURATION_24, '72', post.DURATION_72)[arguments[3]]
